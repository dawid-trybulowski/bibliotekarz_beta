                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <table border="0" align="center" width="590" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                {!! $data['additional']['reservation']['id'] !!}
                                            </td>
                                            <td>
                                                {!! $data['additional']['book']['title'] !!}
                                            </td>
                                            <td>
                                                {!! $data['additional']['book']['author'] !!}
                                            </td>
                                            <td>
                                                {!! $data['additional']['book']['id'] !!}
                                            </td>
                                        </tr>
                                    </table>
                                    <br>
                                    <p>
                                        {!! $data['additional']['text2'] . ' ' . $data['additional']['reservation']['reservation_date_end'] !!}
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">{{$data['libraryName']}}</span>
