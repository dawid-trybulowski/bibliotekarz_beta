<div class="container-fluid">
    <div class="row">
        <form class="col-12 mt-4" method="POST" action="{{route('admin-category-edit')}}" enctype="multipart/form-data">
            <div class="form-row">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{$compact['category']['id']}} ">
                <div class="form-group col-6 {{ $errors->has('category') ? ' has-error' : '' }} width_customize">
                    ...
                    <div class="col-12">
                        <input id="name" name="name" type="text" class="form-control input-md"
                               value="{{ old('name') ? old('name') : $compact['category']['name']}}">
                        @if ($errors->has('name'))
