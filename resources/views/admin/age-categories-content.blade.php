...
<div class="container-fluid">
        ...
        <table class="col-md-12 table-bordered table-striped table-condensed cf text-center">
            ...
            @foreach($compact['ageCategories'] as $ageCategory)
                <tr>
                    ...
                    <td data-title="Min. wiek">{{$ageCategory['min_age']}}</td>
                    <td data-title="Maks. wiek">{{$ageCategory['max_age']}}</td>
    ...
    <div class="pagination center pagination-sm flex-sm-wrap">
        {{$compact['ageCategories']->appends(request()->input())->links("pagination::bootstrap-4")}}
    </div>
</div>
